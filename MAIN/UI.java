...
public class UI extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		mercury.setImage("textures\\Mercury.JPG");
		...
		venus.setImage("textures\\Venus.JPG");
		...
		earth.setImage("textures\\Earth.JPG");
		...
		moon.setImage("textures\\Moon.JPG");
		...
		mars.setImage("textures\\Mars.JPG");
		...
		jupiter.setImage("textures\\Jupiter.JPG");
		...
		saturn.setImage("textures\\Jupiter.JPG");
		...
		titan.setImage("textures\\Titan.JPG");
		...
		uranus.setImage("textures\\Uranus.JPG");
		...
		neptune.setImage("textures\\Neptune.JPG");
		solarSystem.getChildren().add(neptune.getShape());

		ImageView background = new ImageView("textures\\Space.JPG");
