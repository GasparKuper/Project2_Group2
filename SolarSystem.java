...
public class SolarSystem extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        sunMaterial.setSelfIlluminationMap(new Image(getClass().getResourceAsStream("/myUniverse/Map_of_the_full_sun.jpg")));
        ...
        earthMaterial.setDiffuseMap(new Image(getClass().getResourceAsStream("/myUniverse/earthmap-1280x720.jpg")));
